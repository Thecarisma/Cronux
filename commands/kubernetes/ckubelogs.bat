...
REM 
REM The command will show the log of a particular log. The 
REM first parameter is the full name or part name of the pod 
REM to view it log, the pod must be running to show it log 
REM else it log is not shown
REM 
REM 
REM ::
...
REM **Parameters**:	
REM 	param1 : string
REM 		the pod name or part of the pod name to view log
