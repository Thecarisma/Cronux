...
```bash
gitclone, gitpush, $, aboutx, base64, base64s, batforps, buildcronux,
chelp, close, Cronux, extractx, gencert, gencodesigncert, installpfx,
installpfxx, installx, listx, printhead, pstobat, wrapcommand, Bye.
```
