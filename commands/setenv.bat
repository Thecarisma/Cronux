...
if "!NAME!"=="" (
	call:display_error The name of the environement to set or create cannot be empty
	goto:eof
)
if "!VALUE!"=="" (
	call:display_error The value of the environement to set or create cannot be empty
	goto:eof
)
if not "!TARGET!"=="user" (
	if not "!TARGET!"=="User" (
