...
to execute Linux like command such as curl, grep e.t.c. It makes heavey use of meta-programming to achive some functionalities.
...
delpath, zip, archive, unzip, extract, listzip, showzip, qproc, qport, qid, 
