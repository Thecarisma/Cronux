...
noadmin-install, install, rmlong, help, echocolor, colorlist, getenv, setenv, delenv, delenv, 
cat, printfile, ssay, say, testlabel, compilescript, cbackup, backup, chelp, addpath, 
```
